							...
							struct ieee80211_hw *hw)
{
	...
	base = _rtl8723be_phy_get_txpower_by_rate_base(hw, BAND_ON_2_4G, rfPath, RF_1TX, HT_MCS0_MCS7 );
	_phy_convert_txpower_dbm_to_relative_value( 
	...
	base = _rtl8723be_phy_get_txpower_by_rate_base(hw, BAND_ON_2_4G, rfPath, RF_2TX, HT_MCS8_MCS15 );
	_phy_convert_txpower_dbm_to_relative_value( 
...
static bool _rtl8723be_phy_config_mac_with_headerfile(struct ieee80211_hw *hw)
{
	...
	RT_TRACE(COMP_INIT, DBG_TRACE, ("Read rtl8723beMACPHY_Array\n"));
				  ...
				  enum radio_path rfpath, u8 rate)
{
	...
	switch (rate) {
	case DESC92C_RATE1M:	shift = 8;	break;
	case DESC92C_RATE2M:	shift = 8;	break;
	case DESC92C_RATE5_5M:	shift = 16;	break;
	case DESC92C_RATE11M:	shift = 24;	break;			

	case DESC92C_RATE6M:	shift = 0;	break;
	case DESC92C_RATE9M:	shift = 8;      break;
	case DESC92C_RATE12M:	shift = 16;     break;
	case DESC92C_RATE18M:	shift = 24;     break;
			
	case DESC92C_RATE24M:	shift = 0;    	break;
	case DESC92C_RATE36M:	shift = 8;      break;
	case DESC92C_RATE48M:	shift = 16;     break;
	case DESC92C_RATE54M:	shift = 24;     break;
			
	case DESC92C_RATEMCS0:	shift = 0; 	break;
	case DESC92C_RATEMCS1:	shift = 8;      break;
	case DESC92C_RATEMCS2:	shift = 16;     break;
	case DESC92C_RATEMCS3:	shift = 24;     break;
			
	case DESC92C_RATEMCS4:	shift = 0; 	break;
	case DESC92C_RATEMCS5:	shift = 8;      break;
	case DESC92C_RATEMCS6:	shift = 16;     break;
	case DESC92C_RATEMCS7:	shift = 24;     break;
			
	case DESC92C_RATEMCS8:	shift = 0; 	break;
	case DESC92C_RATEMCS9:	shift = 8;      break;
	case DESC92C_RATEMCS10:	shift = 16;     break;
	case DESC92C_RATEMCS11:	shift = 24;     break;
			
	case DESC92C_RATEMCS12:	shift = 0; 	break;
	case DESC92C_RATEMCS13:	shift = 8;      break;
	case DESC92C_RATEMCS14:	shift = 16;     break;
	case DESC92C_RATEMCS15:	shift = 24;     break;
	...
	tx_pwr_diff = (u8) (rtlphy->tx_power_by_rate_offset[band][rfpath][tx_num][rate_section] >> shift) & 0xff;
...
static void _rtl8723be_phy_path_a_standby(struct ieee80211_hw *hw)
{
...
static void _rtl8723be_phy_pi_mode_switch(struct ieee80211_hw *hw, bool pi_mode)
{
	u32 mode;
...
/*	if (is2t)
	...
	if (is2t) {
		_rtl8723be_phy_path_a_standby(hw);
		_rtl8723be_phy_path_adda_on(hw, adda_reg, false, is2t);
	}
	...
	if (t != 0) {
		if (!rtlphy->b_rfpi_enable)
			_rtl8723be_phy_pi_mode_switch(hw, false);
	...
	RT_TRACE(COMP_INIT,DBG_LOUD,("8723be IQK Finish!!\n"));
}
